...
- For all photos, always use Tailwind class "object-fill" (avoid "object-cover" to prevent cropping).
- If you include any formulas/equations or text-based schemes/flows, write them as LaTeX and wrap with $...$ (inline) or $$...$$ (block). Do not use code fences for schemes.
